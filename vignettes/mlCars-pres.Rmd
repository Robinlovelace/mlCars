...
> - An R package, **mlCars** containing the source code and example data to ensure reproducibility. The package can be accessed here: https://github.com/Robinlovelace/mlCars/
...
Liam Bolton, Red Ninja / UCL
liamthomasbolton@gmail.com
