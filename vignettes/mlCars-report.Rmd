...
# library(UKCensusAPI)
# u = "https://opendata.arcgis.com/datasets/5e14c6bedc8740d19683517e5e902057_2.geojson"
# download.file(u, "lads.geojson")
# lads = sf::st_read("lads.geojson")
# plot(lads)
```
...
Note that the results and figures presented in this report can be reproduced, by installing the **mlCars** R package and loading the example data:

```{r, message=FALSE}
devtools::install_github("robinlovelace/mlCars") # install the R package
wyflows = readRDS((system.file(package = "mlCars", "data/wyflows.Rds"))) # load data
```
