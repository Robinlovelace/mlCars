...
The report is self-standing but links to 3 Appendices, which can be consulted for futher details on the input data, methods and policy implications of the research, respectively. They are:
...
In addition, we included the workplace zone classification which assigns each destination MSOA one of the following groups:
