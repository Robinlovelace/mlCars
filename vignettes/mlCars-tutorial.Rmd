...
barplot(counts, xlab='Distance', ylab='', ylim = c(0,14000), main="Car")
```
...
Let's perform some regression analysis. First, we need to do some data cleaning
```{r}
str(wyflows)
...
Ok, let's find out whether there is a statistical relationship between car ownership and health
```{r}
